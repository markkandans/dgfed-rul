...
The manuscript text throughout, the figure-generation code, and the experiment-orchestration scripts were drafted with the assistance of Anthropic's Claude (AI assistant), working under the author's direction. All research questions, method and design decisions, experiments, and interpretations are the author's; all reported results derive from experiments executed by the author and are pinned in the public artifact manifest; and the author reviewed, verified, and takes full responsibility for the entire content.
