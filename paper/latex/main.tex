...
The manuscript text throughout, the figure-generation code, and the experiment scripts were drafted with the assistance of Anthropic's Claude under the author's direction; all research decisions, experiments, and interpretations are the author's, all results derive from author-executed experiments pinned in the public artifact manifest, and the author verified and takes full responsibility for the entire content.
